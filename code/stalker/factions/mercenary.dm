/datum/job_department/stalker/mercenaries
	department_name = DEPARTMENT_STALKER_MERCENARIES
	department_bitflags = DEPARTMENT_STALKER_BITFLAG_MERCENARIES
	ui_color = "#2e708b"
...
/datum/job/stalker/mercenarycommander
	title = JOB_MERCENARYCOMMANDER
	faction_s = "Mercenaries"
	faction = "Station"
	total_positions = 4
	spawn_positions = 4
