...
/obj/item/food/stalker/konserva
	...
	food_reagents = list("nutriment" = 13, "vitamin" = 2, "omnizine" = 0.5)
	icon = 'icons/stalker/food.dmi'
...
/obj/item/food/stalker/konserva/attack_self(mob/user)
	if(wrapped)
		Unwrap(user)
	else
		..()

/obj/item/food/stalker/konserva/proc/Unwrap(mob/user)
...
/obj/item/food/stalker/konserva/shproti
	name = "anchovies"
	...
	food_reagents = list("nutriment" = 17, "vitamin" = 3, "omnizine" = 0.75)
...
/obj/item/food/stalker/konserva/bobi
...
/obj/item/food/stalker/konserva/govyadina2
...
/obj/item/food/stalker/konserva/fish
...
/obj/item/food/stalker/konserva/snack/sirok
	...
	food_reagents = list("nutriment" = 11, "vitamin" = 1, "omnizine" = 0.3)
...
/obj/item/food/stalker/konserva/snack/chocolate
	name = "chocolate"
	desc = "A bar of chocolate. A reminder of home in this harsh place."
	icon_state = "Choco1"
	icon_state_opened = "Choco2"
	food_reagents = list("nutriment" = 9, "sugar" = 1, "omnizine" = 0.1, "energetic" = 5)
...
/obj/item/storage/box/MRE/New()
	..()
	new /obj/item/food/stalker/konserva/galets(src)
	new /obj/item/food/stalker/konserva/galets(src)
	new /obj/item/food/stalker/konserva/galets(src)
	new /obj/item/food/stalker/konserva/galets(src)
	new /obj/item/food/stalker/konserva/kasha(src)
	new /obj/item/food/stalker/konserva/MREkonserva1(src)
...
/obj/item/food/stalker/konserva/galets
	name = "galets"
	...
	food_reagents = list("nutriment" = 10, "omnizine" = 0.1)
...
/obj/item/food/stalker/konserva/kasha
	...
	food_reagents = list("nutriment" = 15, "omnizine" = 0.2)
...
/obj/item/food/stalker/konserva/MREkonserva1
	...
	food_reagents = list("nutriment" = 17, "omnizine" = 0.2)
...
/obj/item/food/stalker/konserva/MREkonserva2
...
/obj/item/food/stalker/konserva/MREkonserva3
	...
	food_reagents = list("nutriment" = 17, "omnizine" = 0.2, "vitamin" = 10)
...
/obj/item/food/stalker/baton
	...
	w_class = 2
	food_reagents = list("nutriment" = 8, "omnizine" = 0.2)
	tastes = list("dry but pleasant bread" = 1)

/obj/item/food/stalker/fermented/tomaty
	name = "pickled tomatoes"
	desc = "Pickled tomatoes of unknown age. Try at your own peril."
	icon_state = "tomaty"
	w_class = 2
	food_reagents = list("nutriment" = 16, "omnizine" = 5, "vitamin" = 10)
	tastes = list("tart, tangy tomatoes. They are a little mushy" = 1)

/obj/item/food/stalker/fermented/sauerkraut
	name = "sauerkraut"
...
/obj/item/food/stalker/kolbasa/doctorsausage
	name = "doctor sausage"
	...
	icon_state = "sausage"
	w_class = 2
	food_reagents = list("nutriment" = 15, "vitamin" = 1, "omnizine" = 0.3)
...
/obj/item/food/stalker/putrescentstew
	...
	icon_state = "stew"
	w_class = 2
	food_reagents = list("nutriment" = 25, "omnizine" = 5, "sodiumchloride" = 2)
...
/obj/item/food/stalker/lowgradestew
	...
	w_class = 2
	food_reagents = list("nutriment" = 20, "omnizine" = 5, "sodiumchloride" = 2)
...
/obj/item/food/stalker/shroomstew
	...
	icon_state = "stew"
	w_class = 2
	food_reagents = list("nutriment" = 15, "sodiumchloride" = 5, "mushroomhallucinogen" = 0.05)
	tastes = list("sand-textured grit with a overbearing earthy flavour. This is horrible.." = 1)

/// BORSCHT

/obj/item/food/stalker/borscht/poor
	...
	icon_state = "beetsoup"
	w_class = 2
	food_reagents = list("nutriment" = 20, "omnizine" = 10, "vitamin" = 5, "sodiumchloride" = 2)
	tastes = list("sand-textured grit with a overbearing earthy flavour. This is horrible.." = 1)
...
/obj/item/food/stalker/borscht
	...
	icon_state = "beetsoup"
	w_class = 2
	food_reagents = list("nutriment" = 25, "omnizine" = 10, "vitamin" = 5, "sodiumchloride" = 2)
...
/obj/item/food/stalker/borscht/luxury
	...
	icon_state = "beetsoup"
	w_class = 2
	food_reagents = list("nutriment" = 30, "omnizine" = 10, "vitamin" = 5, "sodiumchloride" = 2)
...
/obj/item/food/stalker/okroshkasoup
	...
	icon_state = "lowgrade_goulash"
	w_class = 2
	food_reagents = list("nutriment" = 35, "omnizine" = 10, "vitamin" = 5, "sodiumchloride" = 2)
...
/obj/item/food/stalker/ukha
	...
	icon_state = "stew"
	w_class = 2
	food_reagents = list("nutriment" = 35, "omnizine" = 10, "vitamin" = 10, "sodiumchloride" = 2)
...
/obj/item/food/stalker/meatstew/mutantdelight
	...
	icon_state = "meat_goulash"
	w_class = 2
	food_reagents = list("nutriment" = 45, "omnizine" = 10, "vitamin" = 10, "sodiumchloride" = 2)
...
/obj/item/food/stalker/konserva/snack/thebar
	...
	food_reagents = list("lipolicide" = 10, "omnizine" = 1)
	trash_type = /obj/item/trash/konserva/snikers
...
/obj/item/food/stalker/konserva/snack/thebar
	...
	icon_state = "choco1"
	icon_state_opened = "choco2"
	food_reagents = list("nutriment" = 5, "omnizine" = 1, "psicodine" = 1)
	trash_type = /obj/item/trash/konserva/snikers
...
/obj/item/food/stalker/kebab/mutantmeat
	...
	w_class = 2
	food_reagents = list("nutriment" = 30, "omnizine" = 10, "vitamin" = 5, "sodiumchloride" = 5)
...
/obj/item/food/sosjerky/mutant
	...
	food_reagents = list("nutriment" = 25, "vitamin" = 5, "omnizine" = 5, "sugar" = 3, "sodiumchloride" = 2)
	junkiness = 0
...
/obj/item/food/pashtet/mutantmeatmix
	...
	food_reagents = list("nutriment" = 35, "vitamin" = 5, "omnizine" = 5, "sugar" = 3, "sodiumchloride" = 2)
	junkiness = 0
