...
/obj/item/food/stalker/konserva
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 13, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/medicine/omnizine = 0.5)
	icon = 'icons/stalker/food.dmi'
...
/obj/item/food/stalker/konserva/shproti
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 17, /datum/reagent/consumable/nutriment/vitamin = 3, /datum/reagent/medicine/omnizine = 0.75)
...
/obj/item/food/stalker/konserva/soup
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 20, /datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/medicine/omnizine = 1)
...
/obj/item/food/stalker/konserva/snack/sirok
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 11, /datum/reagent/consumable/nutriment/vitamin = 1, /datum/reagent/medicine/omnizine = 0.3)
...
/obj/item/food/stalker/konserva/galets
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 10, /datum/reagent/medicine/omnizine = 0.1)
...
/obj/item/food/stalker/konserva/kasha
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 15, /datum/reagent/medicine/omnizine = 0.2)
...
/obj/item/food/stalker/konserva/MREkonserva1
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 17, /datum/reagent/medicine/omnizine = 0.2)
...
/obj/item/food/stalker/konserva/MREkonserva3
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 17, /datum/reagent/medicine/omnizine = 0.2, /datum/reagent/consumable/nutriment/vitamin = 10)
...
/obj/item/food/stalker/baton
	...
	w_class = 2
	food_reagents = list(/datum/reagent/consumable/nutriment = 8, /datum/reagent/medicine/omnizine = 0.2)
...
/obj/item/food/stalker/fermented/tomaty
	...
	icon_state = "tomaty"
	w_class = 2
	food_reagents = list(/datum/reagent/consumable/nutriment = 16, /datum/reagent/medicine/omnizine = 5, /datum/reagent/consumable/nutriment/vitamin = 10)
...
/obj/item/food/stalker/stew
	...
	icon_state = "stew"
	w_class = 2
	food_reagents = list(/datum/reagent/consumable/nutriment = 25, /datum/reagent/medicine/omnizine = 1, /datum/reagent/consumable/nutriment/vitamin = 5)
...
/obj/item/food/stalker/kolbasa/doctorsausage
	...
	icon_state = "sausage"
	w_class = 2
	food_reagents = list(/datum/reagent/consumable/nutriment = 15, /datum/reagent/consumable/nutriment/vitamin = 1, /datum/reagent/medicine/omnizine = 0.3)
