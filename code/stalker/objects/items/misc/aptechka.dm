/obj/item/reagent_containers/applicator/pill/stalker
...
/obj/item/reagent_containers/applicator/pill/stalker/aptechka
	name = "kit"
	desc = "An old Soviet first aid kit."

/obj/item/reagent_containers/applicator/pill/stalker/canconsume(mob/eater, mob/user)
	if(!iscarbon(eater))
		return 0
	return 1 // Masks were stopping people from "eating" patches. Thanks, inheritance.

/obj/item/reagent_containers/applicator/pill/stalker/afterattack(obj/target, mob/user , proximity)
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/attack_self(mob/user)
	if(wrapped)
		Unwrap(user)
	else
		..()

/obj/item/reagent_containers/applicator/pill/stalker/injector/proc/Unwrap(mob/user)
	icon_state = icon_state_opened
	desc = desc_opened
	to_chat(user, "<span class='notice'>You remove the injectors protective cover.</span>")
	wrapped = 0

/obj/item/reagent_containers/applicator/pill/stalker/injector/canconsume(mob/eater, mob/user)
	if(wrapped == 1)
...
/obj/item/reagent_containers/applicator/pill/stalker/pillbottle/attack_self(mob/user)
	if(wrapped)
		Unwrap(user)
	else
		..()

/obj/item/reagent_containers/applicator/pill/stalker/pillbottle/proc/Unwrap(mob/user)
	icon_state = icon_state_opened
	desc = desc_opened
	to_chat(user, "<span class='notice'>You cracked the protective seal on the pills!</span>")
	wrapped = 0

/obj/item/reagent_containers/applicator/pill/stalker/pillbottle/canconsume(mob/eater, mob/user)
	if(wrapped == 1)
		to_chat(user, "<span class='warning'>The safety seal is still closed! You need to open it to use this.</span>")
		return 0
	return 1 // Masks were stopping people from "eating" patches. Thanks, inheritance.

/obj/item/reagent_containers/applicator/pill/stalker/injector/brute
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/burn
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/toxin
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/oxygen
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/blood
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/painkiller
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/epinephrine
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/antirad
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/ai2
...
/obj/item/reagent_containers/applicator/pill/stalker/pillbottle/radprotectorai2
...
/obj/item/reagent_containers/applicator/pill/stalker/pillbottle/antiradai2
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/armymedicalinjector
	name = "Army injector"
	icon_state = "brute"
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/scimedicalinjector
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/sciradinjector
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/improvisedstim
...
// Army Stimpack
/obj/item/reagent_containers/applicator/pill/stalker/injector/armystim
	name = "Army Stimpack"
	icon_state = "stimarmy"
...
/obj/item/reagent_containers/applicator/pill/stalker/injector/scistim
