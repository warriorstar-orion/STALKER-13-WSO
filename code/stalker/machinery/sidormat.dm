...
//rating_tier
GLOBAL_LIST_EMPTY(rookie_sidormatitems)
GLOBAL_LIST_EMPTY(experienced_sidormatitems)
GLOBAL_LIST_EMPTY(veteran_sidormatitems)
GLOBAL_LIST_EMPTY(expert_sidormatitems)
GLOBAL_LIST_EMPTY(legend_sidormatitems)
...
GLOBAL_LIST_INIT(global_sidormat_list, list(
	...
	"Food" = list(
		...
		new /datum/data/stalker_equipment("Energy drink \"NonStop\"",	"Energy drink \"NonStop\"",	/obj/item/reagent_containers/cup/soda_cans/energetic,			500,	ROOKIE,initial_stock = PISTOL_AMOUNT),
	...
	"Misc" = list(
		...
		new /datum/data/stalker_equipment("Cigarettes \"Maxim\"",				"Cigarettes \"Maxim\"",									/obj/item/storage/fancy/cigarettes/cigpack_maxim,					2500,	ROOKIE,initial_stock = PISTOL_AMOUNT),
		...
		new /datum/data/stalker_equipment("Weed Rollie",						"Weed Rollie",											/obj/item/cigarette/rollie/trippy,					1000,	ROOKIE,	initial_stock = PISTOL_AMOUNT*4,faction = "Freedom"),
...
//		new /datum/data/stalker_equipment("Bolts",								"Bolts",												/obj/item/stalker/bolts,											300,	ROOKIE),
		...
		new /datum/data/stalker_equipment("Russian Vocabulary",					"Russian Vocabulary",									/obj/item/language_manual/codespeak_manual/russian,									10000,	ROOKIE,	initial_stock = SPECIALTY_AMOUNT,faction = "Duty",sale_price = 8000),
		new /datum/data/stalker_equipment("English Vocabulary",					"English Vocabulary",									/obj/item/language_manual/codespeak_manual/english,									10000,	ROOKIE,	initial_stock = SPECIALTY_AMOUNT,faction = "Clear Sky",sale_price = 8000),
		new /datum/data/stalker_equipment("German Vocabulary",					"German Vocabulary",									/obj/item/language_manual/codespeak_manual/german,									10000,	ROOKIE,	initial_stock = SPECIALTY_AMOUNT,faction = "Ecologist",sale_price = 8000),
...
/datum/data/stalker_equipment/New(name, name_ru, path, cost, rating, faction = "Everyone", amount = 5, initial_stock = 10, restock_amount = 1, restock_time = 10 MINUTES, min_restock_time = 15 MINUTES, max_restock_time = 30 MINUTES, sale_price = 0, assortment_level = 0)
	...
	switch(rating)//causes runtimes but whatever. It works 100%. Probably.
		if(0 to ROOKIE)
			GLOB.rookie_sidormatitems += src
		if(0 to EXPERIENCED)
			GLOB.experienced_sidormatitems += src
		if(0 to VETERAN)
			GLOB.veteran_sidormatitems += src
		if(0 to EXPERT)
			GLOB.expert_sidormatitems += src
		if(0 to ZONE_LEGEND)
			GLOB.legend_sidormatitems += src
