...
/obj/item/reagent_containers/cup/glass/bottle/vodka/kazaki
	...
	list_reagents = list(/datum/reagent/consumable/ethanol/vodka = 90, "potass_iodide" = 10)
...
/obj/item/reagent_containers/cup/glass/bottle/vodka/stolichnaya
	...
	list_reagents = list(/datum/reagent/consumable/ethanol/vodka = 80, "potass_iodide" = 20)
	w_class = 2
...
/obj/item/reagent_containers/cup/glass/bottle/vodka/blacklabelvodka
	...
	list_reagents = list(/datum/reagent/consumable/ethanol/vodka = 70, "potass_iodide" = 20, "energetic" = 10)
	w_class = 2
