/obj/item/seeds/beet/red/zona
	...
	reagents_add = list(/datum/reagent/consumable/nutriment/vitamin = 0.05, "nutriment" = 0.05, "uranium" = 0.25)
...
/obj/item/seeds/beet/white/zona
	...
	reagents_add = list(/datum/reagent/consumable/nutriment/vitamin = 0.04, "sugar" = 0.2, "nutriment" = 0.05, "uranium" = 0.25)
...
/obj/item/seeds/carrot/zona
	...
	reagents_add = list("oculine" = 0.25, /datum/reagent/consumable/nutriment/vitamin = 0.04, "nutriment" = 0.05, "uranium" = 0.25)
