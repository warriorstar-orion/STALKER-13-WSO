...
/obj/item/seeds/garlic/zona
	...
	icon_harvest = "garlic-harvest"
	icon_dead = "garlic-dead"
	reagents_add = list(/datum/reagent/uranium = 0.25, /datum/reagent/medicine/oculine = 0.2, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment = 0.1)
