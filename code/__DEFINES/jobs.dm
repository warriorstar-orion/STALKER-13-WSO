...
#define DEPARTMENT_STALKER_BITFLAG_LONERS (1<<10)
#define DEPARTMENT_STALKER_LONERS "Loners"
#define DEPARTMENT_STALKER_BITFLAG_DUTY (1<<11)
#define DEPARTMENT_STALKER_DUTY "Duty"
#define DEPARTMENT_STALKER_BITFLAG_FREEDOM (1<<12)
#define DEPARTMENT_STALKER_FREEDOM "Freedom"
#define DEPARTMENT_STALKER_BITFLAG_BANDITS (1<<13)
#define DEPARTMENT_STALKER_BANDITS "Bandits"
#define DEPARTMENT_STALKER_BITFLAG_ECOLOGISTS (1<<14)
#define DEPARTMENT_STALKER_ECOLOGISTS "Ecologists"
#define DEPARTMENT_STALKER_BITFLAG_CLEARSKY (1<<15)
#define DEPARTMENT_STALKER_CLEARSKY "Clear Sky"
#define DEPARTMENT_STALKER_BITFLAG_MILITARY (1<<16)
#define DEPARTMENT_STALKER_MILITARY "Military"
#define DEPARTMENT_STALKER_BITFLAG_MONOLITH (1<<17)
#define DEPARTMENT_STALKER_MONOLITH "Monolith"
#define DEPARTMENT_STALKER_BITFLAG_MERCENARIES (1<<18)
#define DEPARTMENT_STALKER_MERCENARIES "Mercenaries"
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	"LONERS" = DEPARTMENT_STALKER_BITFLAG_LONERS,
	"DUTY" = DEPARTMENT_STALKER_BITFLAG_DUTY,
	"FREEDOM" = DEPARTMENT_STALKER_BITFLAG_FREEDOM,
	"BANDITS" = DEPARTMENT_STALKER_BITFLAG_BANDITS,
	"ECOLOGISTS" = DEPARTMENT_STALKER_BITFLAG_ECOLOGISTS,
	"CLEARSKY" = DEPARTMENT_STALKER_BITFLAG_CLEARSKY,
	"MILITARY" = DEPARTMENT_STALKER_BITFLAG_MILITARY,
	"MONOLITH" = DEPARTMENT_STALKER_BITFLAG_MONOLITH,
))
